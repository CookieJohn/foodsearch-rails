class User < ApplicationRecord
  ...
  validates :max_distance, presence: true, numericality: {
    greater_than_or_equal_to: 500, less_than_or_equal_to: 50_000
  }
  validates :min_score, presence: true, numericality: {
    greater_than_or_equal_to: 3, less_than_or_equal_to: 5
  }
